...
from mlx4ocr.models.common import Conv2DBN, ConvBNAct, HardSigmoid, SELayer, build_activation
from mlx4ocr.models.common.conv_bn import apply_same_padding_nhwc
from mlx4ocr.models.det.config import BlockSpec
